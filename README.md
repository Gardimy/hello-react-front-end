...
**["Hello world" FRONT END]** 💰💼 I have  created a React front-end with a Rails back-end and connect them to display a random message the link of the [Rails Back End App](https://github.com/Gardimy/hello-rails-back-end)
